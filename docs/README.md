...
- `browser-session-init.md`
  browser launch, login-session preparation, Playwright CDP verification, saved session reuse, and session config output
- `powershell-encoding.md`
  Windows / PowerShell encoding notes for browser automation work
